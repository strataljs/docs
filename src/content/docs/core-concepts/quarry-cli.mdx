...
| `mcp:serve` | Start MCP stdio server exposing routes as tools | [AI Integration](/integrations/ai/) |
| `mcp:tools` | List API routes exposed as MCP tools | [AI Integration](/integrations/ai/) |
...
- [AI Integration](/integrations/ai/) for exposing your API as MCP tools.
